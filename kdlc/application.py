...
def main():
    ...
    input_connection_list = kdlc.extract_connections(f'{input_workflow_path}/workflow.knime')
    ...
    output_workflow_knime = kdlc.create_workflow_knime_from_template(input_node_list, input_connection_list)
